    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>Carts Customer</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.carts_customer &&
                      Array.isArray(users.carts_customer) &&
                      users.carts_customer.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(`/carts/carts-view/?id=${item.id}`)
                          }
                        ></tr>
                      ))}
                  </tbody>
